...
import com.example.foodapplicationkot.databinding.ActivityRecentBuyItemBinding
...
class RecentBuyAdapter(private var context:Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecentViewHolder {
        val binding = ActivityRecentBuyItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
   ...
   inner class RecentViewHolder(
        private val binding: ActivityRecentBuyItemBinding):RecyclerView.ViewHolder(binding.root)
    {
