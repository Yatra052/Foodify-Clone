...
import com.example.foodapplicationkot.Adapter.BuyAgainAdapter
import com.example.foodapplicationkot.Model.OrderDetails
import com.example.foodapplicationkot.databinding.FragmentHistoryBinding
import com.example.foodapplicationkot.RecentOrderItems
...
class HistoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recentBuyItems.setOnClickListener{
            seeItemsRecentBuy()
        }
    ...
    private fun seeItemsRecentBuy() {
        listOfOrderItem.firstOrNull()?.let { recentBuy ->
            ...
            intent.putExtra("RecentBuyItem", listOfOrderItem)
