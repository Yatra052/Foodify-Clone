...
import com.example.foodapplicationkot.databinding.ActivityPayOutBinding
...
class PayOutActivity : AppCompatActivity() {
    ...
    private fun placeOrder() {
        ...
        val orderDetails = OrderDetails(userId, name, foodItemName, foodItemPrice, foodItemImage, foodItemQuantities, address, phone, time, itemPushKey, false, false)
            //OrderDetails(userId, name, foodItemName,  foodItemPrice, foodItemImage, foodItemQuantities, address, phone, time, itemPushKey, false, false)
